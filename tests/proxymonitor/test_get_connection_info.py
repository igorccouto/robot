...
def test_get_connection_info_response_keys_NOT_MOCKED():
...
def test_get_connection_info_deals_with_ConnectTimeout():
...
def test_get_connection_info_deals_with_ConnectionError():
    error_msg = 'ANY ERROR MESSAGE'
    with mock.patch('robot.proxymonitor.proxytools.requests.get') as mock_get:
...
def test_get_connection_info_deals_with_JSONDecodeError():
    error_msg = 'ANY ERROR MESSAGE'
